  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-8 bg-gray-100 dark:bg-gray-900">
      <header className="w-full max-w-4xl mx-auto flex justify-between items-center py-4">
        <Image src="/logo.png" alt="App Logo" width={50} height={50} className="dark:invert" />
      ...
      <main className="flex flex-col items-center justify-center flex-1 text-center">
        ...
        <p className="text-lg mb-8">Experience the best AI-powered tools and features.</p>
      ...
      <footer className="w-full max-w-4xl mx-auto flex justify-between items-center py-4">
        <p className="text-sm text-gray-600 dark:text-gray-400">&copy; {new Date().getFullYear()} Our App. All rights reserved.</p>
        <nav className="flex gap-4">
          {/* <Link href="/privacy">
