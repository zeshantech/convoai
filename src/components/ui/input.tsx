...
const Input = forwardRef<HTMLInputElement, InputProps>(({ className, inputClassName, type, label, error, passwordVisibility = true, ...props }, ref) => {
    ...
    <div className={cn("space-y-2", className)}>
      ...
      <div className="relative">
        ...
        {shouldShowPasswordToggle && (
          <button type="button" onClick={togglePasswordVisibility} className="absolute right-3 top-1/2 -translate-y-1/2 text-neutral-500 hover:text-neutral-700 dark:text-neutral-400 dark:hover:text-neutral-300">
